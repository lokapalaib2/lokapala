...
<div ng-controller="TagController" class="ng-cloak">
    <div class="col-xs-12">
          <div class="box">
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                ...
                                <div class="form-group">
                                    <input ng-model="form.name" type="text" placeholder="Name" id="name" name="name" class="form-control" required />
                                </div>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                ...
                                <div class="form-group">
                                    <input ng-model="form.meta_title" type="text" placeholder="Meta_title" name="meta_title" class="form-control"  />
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12">
                              <strong>Meta Description : </strong>
                                <div class="form-group">
                                  <textarea ng-model="form.meta_description" class="form-control" rows="5" name="meta_description" ></textarea>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12">
                              <strong>Set Populer</strong>                                       
                                <div class="radio">
                                      <label><input type="radio" value="0" name="is_populer"    ng-model="form.is_populer">Not Populer</label>
                                </div>
                                <div class="radio">
                                  <label><input type="radio" value ="1" name="is_populer"  ng-model="form.is_populer">Populer</label>
                                </div>                                
                            </div>
